...
import sys
 ...
 ############################################
 #
 # Author: ASOSYAL ALBAY
 # Contact: www.facebook.com/albay.xl
 #
 # ReTTO Bilisim | ReTTO.Ga
 #
 ############################################
...
class attack(threading.Thread):
     ...
     def run(self):
         print "www.facebook.com/albay.xl - CTRL+Z STOPPED"
...
if len(sys.argv) < 2:
     print "Kullanim: "+ sys.argv[0] +" <IP> <PORT> <9999> <13>"
     sys.exit()
